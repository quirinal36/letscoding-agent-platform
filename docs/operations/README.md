# Lounge Deploy 운영 인덱스

1차 운영 원본이다. 실제 Lounge 작품 업로드는 어느 runbook에도 포함하지 않는다.

- [배포·승격·rollback](deployment-runbook.md)
- [정책 발행·긴급 변경](policy-release-runbook.md)
...
`.env` 값, token, 학생 개인정보를 이슈·로그·증빙에 복사하지 않는다.
